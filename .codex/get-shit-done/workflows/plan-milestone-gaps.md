...
HIGHEST=$(node "C:/Users/kptsa/OneDrive/Documents/GitHub/AtomBerg-Advanced-Fan-Sleep-Mod/.codex/get-shit-done/bin/gsd-tools.cjs" phases list --pick directories[-1])
```
...
```bash
node "C:/Users/kptsa/OneDrive/Documents/GitHub/AtomBerg-Advanced-Fan-Sleep-Mod/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs(roadmap): add gap closure phases {N}-{M}" --files .planning/ROADMAP.md .planning/REQUIREMENTS.md
```
