...
```bash
node "C:/Users/kptsa/OneDrive/Documents/GitHub/AtomBerg-Advanced-Fan-Sleep-Mod/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: plant seed — {$IDEA}" --files .planning/seeds/SEED-{PADDED}-{slug}.md
```
</step>
